...
`.trim();var y5=F("<p>The sum of all invalid ids is <!>."),b5=F("<p>The sum of all invalid ids using the new rules is <!>.");const r4=()=>m5.split(",").map(e=>e.split("-")).map(([e,t])=>({from:Number(e),to:Number(t)})),s4=(e,t,n=!1)=>{const r=[];for(let s=e;s<=t;s++){const i=s.toString(),o=new RegExp(`^(\\d+)\\1${n?"+":""}$`,"gu");i.match(o)&&r.push(s)}return r};function v5(){const e=r4().flatMap(({from:t,to:n})=>s4(t,n)).reduce(X);return(()=>{var t=y5(),n=t.firstChild,r=n.nextSibling;return r.nextSibling,_(t,y(z,{children:e}),r),t})()}function w5(){const e=r4().flatMap(({from:t,to:n})=>s4(t,n,!0)).reduce(X);return(()=>{var t=b5(),n=t.firstChild,r=n.nextSibling;return r.nextSibling,_(t,y(z,{children:e}),r),t})()}const $5=Object.freeze(Object.defineProperty({__proto__:null,Part1:v5,Part2:w5},Symbol.toStringTag,{value:"Module"})),x5=`
...
`.trim();var S5=F("<p>The maximum joltage when using 2 batteries is <!>."),A5=F("<p>The maximum joltage when using 12 batteries is <!>.");const i4=()=>x5.split(`
`).map(e=>e.split("").map(Number)),a4=(e,t)=>{let n=0,r="";for(let s=0;s<t;s++){const i=e.slice(n,e.length-t+s+1),o=Math.max(...i);n+=i.indexOf(o)+1,r+=o}return Number(r)};function _5(){const e=i4().map(t=>a4(t,2)).reduce(X);return(()=>{var t=S5(),n=t.firstChild,r=n.nextSibling;return r.nextSibling,_(t,y(z,{children:e}),r),t})()}function F5(){const e=i4().map(t=>a4(t,12)).reduce(X);return(()=>{var t=A5(),n=t.firstChild,r=n.nextSibling;return r.nextSibling,_(t,y(z,{children:e}),r),t})()}const C5=Object.freeze(Object.defineProperty({__proto__:null,Part1:_5,Part2:F5},Symbol.toStringTag,{value:"Module"})),P5=`
@@.@@@@..@@.@@@.@@@@@@@..@@.@.@@@@@@@.@@...@@@@...@@@@..@@@@..@...@@..@@@..@@@.@.@.@@@@@.@@@.@.@..@.@@.@@@..@...@@..@@.@@@@@@@.@@@@@@...@.@
...@.@@.@@@@@@@.@@@..@@..@@@@.@@@.@..@@..@.@.@..@@@@@@.@@@...@@@@.@@@@@.@@@@@@.@..@..@.@.@@@@.@.@@.@@@@...@@.@.@@@.@@@@@.@...@.@@@@@@.@.@..
@..@.@@@@.......@@@@@@@@.@@@.@.@@@@@@..@@@@..@...@.@@..@...@@.@@@@@@...@@@@@..@@@@...@.@@@@@@@@..@@@@.@..@@..@..@.@@@@.@@..@@.@@.@@@@@@.@@.
@@@@.@@@.@@@@.@@@@@@@.@@@@@..@@@@@@@.@@......@@@@.@.@@@.@@@....@@@@.@@@.@.@@.@..@..@@.@@.@.@@@@@@@@@@...@@..@@@@@@.......@@@..@@@@@.@@@@@.@
...
93543372994982
495748168198728
`.trim();var D5=F("<p> of the available ingredient IDs are fresh."),z5=F("<p> ingredient IDs are considered fresh.");const R4=()=>{const[e,t]=N5.split(`

`);return{freshIds:e.split(`
`).map(n=>n.split("-").map(Number)),ingredients:t.split(`
`).map(Number)}},B5=(e,t)=>t.some(([n,r])=>e>=n&&e<=r),V5=e=>{const[t,...n]=e.sort(V2(([s])=>s,([,s])=>s)),r=[t];for(const[s,i]of n){const o=r.length-1,a=r[o][1];s<=a?r[o][1]=Math.max(a,i):r.push([s,i])}return r};function U5(){const{freshIds:e,ingredients:t}=R4(),n=t.filter(r=>B5(r,e)).length;return(()=>{var r=D5(),s=r.firstChild;return _(r,y(z,{children:n}),s),r})()}function q5(){const{freshIds:e}=R4(),t=V5(e).map(([n,r])=>r-n+1).reduce(X);return(()=>{var n=z5(),r=n.firstChild;return _(n,y(z,{children:t}),r),n})()}const H5=Object.freeze(Object.defineProperty({__proto__:null,Part1:U5,Part2:q5},Symbol.toStringTag,{value:"Module"})),u4=`
...
.^.^.^.^.^.....^.^.^.^.^.^.^.^.^...^.....^.^...^...^.^...^...^.....^...^.^.......^.^.....^.^...^.^.^.^.^.^.^.^.^.^.^.^.^.......^.^.^...^.^.^.
.............................................................................................................................................
`.trim();var e6=F("<p>The beam will be split <!> times."),t6=F("<p>The particle ends up on <!> different timelines.");const c4=()=>Q5.split(`
`).map(e=>e.split("")),f4=function*(e){const t=e[0].indexOf("S"),n=new Map([[t,1]]);let r=0;for(let i=1;i<e.length;i++){const o=Array.from(n).filter(([,a])=>a>0);for(const[a,l]of o)e[i][a]==="^"?(n.set(a-1,(n.get(a-1)??0)+l),e[i][a-1]="|",n.set(a+1,(n.get(a+1)??0)+l),e[i][a+1]="|",n.set(a,0),r++):e[i][a]="|";yield{grid:e,numSplits:r,totalPaths:0}}const s=Array.from(n.values()).reduce(X);yield{grid:e,numSplits:r,totalPaths:s}};function n6(){const[e,t]=N(""),[n,r]=N(null),[s,i]=N(!1);return c2(()=>{r(null),t("");const o=c4(),a=f4(o);if(s()){let l=0;const R=Y3(()=>{const{value:u,done:c}=a.next();u&&(l=u.numSplits,t(J3(u.grid))),c&&(r(l),clearInterval(R))},100);n2(()=>clearInterval(R))}else{const{numSplits:l}=[...a].pop();r(l)}}),[y(Z,{get when(){return n()},get children(){var o=e6(),a=o.firstChild,l=a.nextSibling;return l.nextSibling,_(o,y(z,{get children(){return n()}}),l),o}}),y(o4,{get show(){return s()},setShow:i,get children(){return e()}})]}function r6(){const e=c4(),{totalPaths:t}=[...f4(e)].pop();return(()=>{var n=t6(),r=n.firstChild,s=r.nextSibling;return s.nextSibling,_(n,y(z,{children:t}),s),n})()}const s6=Object.freeze(Object.defineProperty({__proto__:null,Part1:n6,Part2:r6},Symbol.toStringTag,{value:"Module"})),i6=`
61744,9180,64475
90632,13320,37182
18278,48762,4317
21198,64576,34277
...
97534,49037
97534,50245
`.trim();var f6=F("<p>The largest area of any rectangle is <!>."),d6=F("<p>The largest area of any rectangle using only red and green tiles is <!>.");const p4=()=>c6.split(`
